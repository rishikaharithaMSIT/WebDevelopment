...
// 	);
// console.log(imdb);
// console.log(imdb.results[0].vote_count);
var data = {
  "page": 1,
...
function setContent(obj,j) {
	console.log(obj.results[j].backdrop_path);
	checkEnds(j);
	document.getElementById("img").innerHTML = "<img src ='https://image.tmdb.org/t/p/w500" + obj.results[j].poster_path+"' >";
	document.getElementById("rating").innerHTML = "RATING : " + obj.results[j].vote_average;
	document.getElementById("moviename").innerHTML = obj.results[j].title;
	document.getElementById("date").innerHTML = obj.results[j].release_date;
	document.getElementById("overview").innerHTML = obj.results[j].overview;
}
function checkEnds(k) {
	if(k === 0) {
		document.getElementById("previous").setAttribute("class", "btn btn-info disabled"); 
		document.getElementById("next").setAttribute("class", "btn btn-info");
	}
	else if(k === len-1) {
		document.getElementById("previous").setAttribute("class", "btn btn-info");
		document.getElementById("next").setAttribute("class", "btn btn-info disabled");
	} else {
		document.getElementById("previous").setAttribute("class", "btn btn-info");
		document.getElementById("next").setAttribute("class", "btn btn-info");
	}
